...
contract zip004 is TimelockProposal {
    ...
    function description() public pure override returns (string memory) {
        return "ZTX Wearables tokenIds and MaxSupply config proposal - consolidates all historical wearable supplies";
    }
    ...
    function _setAndConfirmData() private {
        ...
        assertEq(wearableTokenIDMaxSupplySettings.length, 204, "Invalid wearableTokenIDMaxSupplySettings length");
        ...
        assertEq(wearableMaxSupplyTotal, 13843695, "Invalid maxSupplyTotal for wearables");
    }
