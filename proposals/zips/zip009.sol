...
contract zip004 is TimelockProposal {
    ...
    function description() public pure override returns (string memory) {
        return "ZTX Wearables tokenIds and MaxSupply config proposal - consolidates all historical wearable supplies - part 6";
    }
    ...
    function _setAndConfirmData() private {
        ...
        assertEq(wearableMaxSupplyTotal, 3730000, "Invalid maxSupplyTotal for wearables");
    }
