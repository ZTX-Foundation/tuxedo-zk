...
/*
Creator Mainnet (chain ID 2787) deployment.

Env vars:
    ADDRESS_FILE  — address JSON filename without extension (default: creator-mainnet)
    ENVIRONMENT   — used for metadata URI subdomain (e.g. "mainnet")
...
contract BootstrapMainnetPhase1 is Script {
    Addresses addresses;
    Proposal[] public proposals;

    function setUp() public {
        string memory addressFile = vm.envOr("ADDRESS_FILE", string("creator-mainnet"));
    ...
    function run() public {
        ...
        console.log("  1. Add deployed addresses to creator-mainnet.json");
        console.log("  2. From ADMIN_MULTISIG, call core.grantRole(Roles.ADMIN, ADMIN_TIMELOCK_CONTROLLER)");
        console.log("  3. Run BootstrapMainnetPhase2");
    }
}

contract BootstrapMainnetPhase2 is Script {
    Addresses addresses;
    Proposal[] public proposals;
